...
import { Alert, FlatList, KeyboardTypeOptions, TextInput, TouchableOpacity, View, Text, Image } from 'react-native'
...
const FlatListTextInput = () => {
    ...
    const renderItem = ({ item }: { item: OutputItem }) => (
        <TextInput
            style={item.id === '00001' ? style.input : item.id === '00002' ? style.input2 : item.id === '00003' ? style.input2 : style.input}
    ...
    return (
        <View >
            ...
            <View style={style.inputArea2}>
                <TouchableOpacity style={style.icon2} onPress={() => setHidePass2(hp => !hp)}>
                    {hidePass2 ?
